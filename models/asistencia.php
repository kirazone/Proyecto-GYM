...
class AsistenciaModel{
    ...
    $actualizarEntrada = $asistencias->actualizarEntrada($nueva_entrada, $fecha, $id_estudiante, $id_asistencia);
    {
        $consult = $this->pdo->prepare("UPDATE asistencias SET ingreso=?, fecha=?, id_estudiante=? WHERE id = ?");
        return $consult->execute([$entrada, $fecha, $id_estudiante, $id]);
    }
