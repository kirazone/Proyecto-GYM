          ...
          <div class="card">
            <div class="card-body">
              <div class="d-sm-flex justify-content-center justify-content-sm-between py-2">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://www.SISTEMASGARCIA.com/" target="_blank">SISTEMASGARCIA </a>2024</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">DESARROLLADO POR <a href="https://www.SISTEMASGARCIA.com/" target="_blank"> SISTEMASGARCIA</a> COMPANY</span>
              </div>
            </div>
          </div>
        </footer>
